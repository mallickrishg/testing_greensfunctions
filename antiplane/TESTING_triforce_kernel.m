...
ex = @(w,l) (1/4).*l.^(-1).*pi.^(-1).*w.^(-1).*(l.^2+w.^2).^(-1).*abs(l.*w).*( ...
...
ey = @(w,l) (1/4).*l.^(-1).*pi.^(-1).*abs(l.*w).*((-1).*(l.^2+w.^2).^( ...
  -1).*((-2).*(l.^2+w.^2)+2.*(l.*(w+(-1).*x)+(-1).*w.*y).* ...
  atan2(l.^2+w.*x+(-1).*l.*y, l.*w+(-1).*l.*x+(-1).*w.*y)+2.*( ...
  l.*(w+(-1).*x)+(-1).*w.*y).*atan2(w.^2+(-1).*w.*x+l.*y, l.* ...
  w+(-1).*l.*x+(-1).*w.*y)+(l.^2+w.*x+(-1).*l.*y).*log(x.^2+( ...
  l+(-1).*y).^2)+(w.^2+(-1).*w.*x+l.*y).*log((w+(-1).*x).^2+ ...
  y.^2))+w.^(-1).*((-2).*w+2.*y.*(atan2(w+(-1).*x, y)+atan2(x, ...
   y))+(w+(-1).*x).*log((w+(-1).*x).^2+y.^2)+x.*log(x.^2+y.^2) ...
  ));
